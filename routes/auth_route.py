...
from controllers.auth_controller import login, profile, register,staff_type, login_user,login_staff, register_user, logout

auth = Blueprint('auth', __name__)

auth.route('/login', methods=['GET'], strict_slashes=False)(login),
auth.route('/profile', methods=['GET'], strict_slashes=False)(profile),
...
auth.route('/register_user', methods=['GET','POST'], strict_slashes=False)(register_user),
